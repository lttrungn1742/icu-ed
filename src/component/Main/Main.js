...
const Main = () => {
  ...
  return (
    <Box width="50%" className={useStyles.container} margin="auto">
      <Stack spacing={2} width="100%" className={useStyles.stackContainer}>
        <Paper>
          <form onSubmit={Cal}>
            <Grid xs={12}>
              <TextField 
      ...
      <Stack  spacing={2} className={useStyles.stackContainer} marginTop="5%">
        {/* <Paper> */}
